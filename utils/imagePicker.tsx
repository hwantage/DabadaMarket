...
export type PickerErrorCode = 'PICKER_CANCELLED' | 'NO_LIBRARY_PERMISSION' | 'NO_CAMERA_PERMISSION';
...
type MultipleImagePickerType = {
  openPicker<T extends MediaType = MediaType.ALL>(options: MultiPickerOptions & Options<T>): Promise<MediaTypeResults[T][]>;
  openPicker<T extends MediaType = MediaType.ALL>(options: SinglePickerOptions & Options<T>): Promise<MediaTypeResults[T]>;
};
