        ...
        <View style={styles.form}>
          ...
          <View style={styles.radioGroup}>
            <View style={styles.container}>
              <BouncyCheckbox size={18} fillColor="#039DF4" unfillColor="#FFFFFF" text="그냥바다" innerIconStyle={{borderRadius: 12}} iconStyle={{borderRadius: 12, width: 11, height: 11.5}} disableBuiltInState={true} isChecked={product.p_badatype === 'free' ? true : false} textStyle={styles.chkTxt} checkIconImageSource={false} onPress={() => setProduct({...product, p_badatype: 'free'})} />
            </View>
            <View style={styles.container}>
              <BouncyCheckbox size={18} fillColor="#039DF4" unfillColor="#FFFFFF" text="현금바다" innerIconStyle={{borderRadius: 12}} iconStyle={{borderRadius: 12, width: 11, height: 11.5}} disableBuiltInState={true} isChecked={product.p_badatype === 'money' ? true : false} textStyle={styles.chkTxt} checkIconImageSource={false} onPress={() => setProduct({...product, p_badatype: 'money'})} />
            </View>
            <View style={styles.container}>
              <BouncyCheckbox size={18} fillColor="#039DF4" unfillColor="#FFFFFF" text="한잔바다" innerIconStyle={{borderRadius: 12}} iconStyle={{borderRadius: 12, width: 11, height: 11.5}} disableBuiltInState={true} isChecked={product.p_badatype === 'drink' ? true : false} textStyle={styles.chkTxt} checkIconImageSource={false} onPress={() => setProduct({...product, p_badatype: 'drink'})} />
            </View>
            <View style={styles.container}>
              <BouncyCheckbox size={18} fillColor="#039DF4" unfillColor="#FFFFFF" text="몰래바다" innerIconStyle={{borderRadius: 12}} iconStyle={{borderRadius: 12, width: 11, height: 11.5}} disableBuiltInState={true} isChecked={product.p_badatype === 'secret' ? true : false} textStyle={styles.chkTxt} checkIconImageSource={false} onPress={() => setProduct({...product, p_badatype: 'secret'})} />
            </View>
          </View>
